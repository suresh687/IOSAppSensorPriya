...
class PSensorTableViewController: UITableViewController,UINavigationControllerDelegate,UISearchBarDelegate,UISearchDisplayDelegate {
   ...
   // var indextoEdit: Int?
    ...
    override func viewDidLoad() {
        ...
        // self.navigationItem.rightBarButtonItem = self.editButtonItemvar searchBar = UISearchBar()
  ...
  //  override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        if !searchText.isEmpty{
            ...
            let fetchRequst = NSFetchRequest<NSFetchRequestResult>(entityName: "Sensor")
            fetchRequst.predicate = predicate
            do{
                items = try managedObjectContext.fetch(fetchRequst) as! [Sensor]
